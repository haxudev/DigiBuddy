...
Chat users pick a profile from the capability card in the chat header — the only setting the chat window exposes; it travels to the agent as `metadata.profile`.
