...
import { CREDENTIAL_SLOTS, type CredentialSlot, type CredentialStatus } from "./credential-types.ts";
export { CREDENTIAL_SLOTS, type CredentialSlot, type CredentialStatus } from "./credential-types.ts";
