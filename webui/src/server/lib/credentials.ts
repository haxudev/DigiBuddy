...
import { CREDENTIAL_SLOTS, type CredentialSlot, type CredentialStatus } from "../../lib/credential-types.ts";
export { CREDENTIAL_SLOTS, type CredentialSlot, type CredentialStatus } from "../../lib/credential-types.ts";
