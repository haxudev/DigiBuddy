...
import { NotSignedInError, requirePrincipal } from "../../lib/identity.ts";
import { DEFAULT_PROFILE_NAME } from "../../../lib/profile-capabilities.ts";
import { resolveUserCommands } from "../../lib/user-commands.ts";
