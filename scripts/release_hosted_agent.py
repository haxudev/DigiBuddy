...
class ReleaseRunner:
    ...
    def _build_acr_image(self, *, repository: str, dockerfile: str, tag: str) -> str:
        self._run_checked(
            [
                "az",
                "acr",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--release-root", default=str(ReleaseConfig.release_root), help="Directory for non-secret release receipts.")
    parser.add_argument("--account-name", default=ReleaseConfig.account_name)
    parser.add_argument("--project-name", default=ReleaseConfig.project_name)
    parser.add_argument("--agent-name", default=ReleaseConfig.agent_name)
    parser.add_argument("--acr-name", default=ReleaseConfig.acr_name)
    parser.add_argument("--hosted-image-repository", default=ReleaseConfig.hosted_image_repository)
    parser.add_argument("--webui-image-repository", default=ReleaseConfig.webui_image_repository)
    parser.add_argument("--webapp-name", default=ReleaseConfig.webapp_name)
    parser.add_argument("--webapp-resource-group", default=ReleaseConfig.webapp_resource_group)
