...
- [x] **Step 3: Version the documents**
...
- [x] **Step 4: Make profile resolution fail closed**
...
- [x] **Step 5: Add conditional writes and retention**
...
- [x] **Step 6: Republish the catalogue when the registry changes**
...
- [x] **Step 7: Add the kill switches**
...
- [ ] **Step 1: Measure the container-to-session mapping with a valid probe** *(needs a deployed agent; `scripts/probe_runtime_isolation.py` is ready to run)*
...
- [x] **Step 2: Measure parent-environment exposure**
...
- [x] **Step 3: Measure what the ambient identity still reaches**
...
- [x] **Step 4: Record the verdict and its consequences**
...
- [x] **Step 3: Report the effective profile from the runtime**
...
- [x] **Step 4: Carry it through the proxy into session state**
...
- [x] **Step 5: Make the console follow the session, not the page**
...
- [x] **Step 6: Express the binding in the UI**
...
- [x] **Step 9: Fix the documentation drift**
...
- [x] **Step 3: Create the workspace id before any side effect**
...
- [x] **Step 4: Route everything through it**
...
- [x] **Step 5: Name the property honestly**
...
- [x] **Step 6: Run the runtime suite**
...
- [x] **Step 7: Re-run the Task 2 probe**
...
- [x] **Step 1: Inventory the environment before restricting it**
...
- [x] **Step 2: Write failing environment and credential tests**
...
- [x] **Step 4: Build the child environment explicitly (T1)**
...
- [x] **Step 5: Add the credential model**
...
- [x] **Step 6: Resolve the MCP bearer token per profile**
...
- [x] **Step 7: Run the runtime suites**
...
- [x] **Step 8: Close the parent environment (T2)**
...
- [x] **Step 10: Make logging secret-safe**
...
- [x] **Step 11: Add the write-only admin surface**
...
- [x] **Step 12: Run the console suite**
...
- [x] **Step 13: State the security position**
...
- [x] **Step 3: Extend the manifest and emit typed artifacts**
...
- [x] **Step 4: Relax the skill-shaped assumption in the runtime**
...
- [x] **Step 5: Bind approval to bytes**
...
- [x] **Step 6: Extend the registry and add the pack receipt**
...
- [x] **Step 7: Show it in the console without offering activation**
...
- [x] **Step 3: Add the approval state machine**
...
- [x] **Step 4: Publish pack tools behind a launcher**
...
- [x] **Step 5: Render approved MCP servers only**
...
- [x] **Step 6: Make installation survive a bad artifact**
...
- [x] **Step 7: Publish observed state**
...
- [x] **Step 8: Expose the stdio form in the MCP tab**
...
- [x] **Step 10: Verify against the built image**
...
- [x] **Step 3: Implement the trigger on unbound sessions**
...
- [x] **Step 4: Handle a bound session honestly**
...
- [x] **Step 7: Document the interaction**
...
- [x] **Step 2: Make the release flag-aware**
...
- [ ] **Step 3: Roll out in order** *(needs an Azure environment)*
...
- [ ] **Step 4: Rehearse the rollback** *(needs an Azure environment)*
